...
class AttributesControllerTest < ActionController::TestCase
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post :create, attribute: { description: @attribute.description, name: @attribute.name, type: @attribute.type, value: @attribute.value }
    end
  ...
  test "should update attribute" do
    put :update, id: @attribute, attribute: { description: @attribute.description, name: @attribute.name, type: @attribute.type, value: @attribute.value }
    assert_redirected_to attribute_path(assigns(:attribute))
  end
